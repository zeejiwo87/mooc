            ...
            <div class="modal-header">
                <div class="neo-modal-title-wrap">
                    ...
                    <div>
                        ...
                        <p class="neo-modal-subtitle">Informasi lengkap sub kategori kelas</p>
                    </div>
                </div>
                ...
                <div class="neo-detail-grid">
                    <div class="neo-section">
                        ...
                        <div class="neo-detail-field">
                            ...
                            <p id="detail_kategori_nama" class="neo-detail-value"></p>
                        </div>
                        ...
                        <div class="neo-metric-row">
                            <div class="neo-metric-card">
                                ...
                                <p id="detail_urutan" class="neo-metric-value"></p>
                            </div>
                            ...
                            <div class="neo-metric-card">
                                ...
                                <p id="detail_aktif" class="neo-metric-value"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="neo-section">
                        ...
                        <div class="neo-detail-field">
                            ...
                            <p id="detail_deskripsi" class="neo-detail-value long-text"></p>
                        </div>
                    </div>
                </div>
            </div>
