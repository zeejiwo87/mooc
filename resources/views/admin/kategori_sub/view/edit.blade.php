                ...
                <div class="modal-header">
                    <div class="neo-modal-title-wrap">
                        ...
                        <div>
                            ...
                            <p class="neo-modal-subtitle">Perbarui data sub kategori kelas</p>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="neo-form-grid">
                        <div class="neo-section">
                            ...
                            <div class="neo-field">
                                <label class="neo-label required" for="edit_id_kategori">Kategori Induk</label>
                            ...
                            <div class="neo-field">
                                <label class="neo-label required" for="edit_nama">Nama Sub Kategori</label>
                                <input type="text"
                                       id="edit_nama"
                            ...
                            <div class="neo-field">
                                ...
                                <div class="neo-radio-group">
                                    <label class="neo-radio-card" for="edit_aktif_ya">
                                        <input class="form-check-input" type="radio" name="edit_aktif" id="edit_aktif_ya" value="1">
                                        <span class="form-check-label">Aktif</span>
                                    </label>

                                    <label class="neo-radio-card" for="edit_aktif_tidak">
                                        <input class="form-check-input" type="radio" name="edit_aktif" id="edit_aktif_tidak" value="0">
