                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" id="edit_id_pengguna"
                                        class="form-select form-select-sm fs-sm-8 fs-lg-6" data-allow-clear="true"
                                        data-placeholder="Pilih Pengguna" data-dropdown-parent="#form_edit" required>
                                    <option></option>
                                </select>
                            ...
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select data-control="select2" id="edit_id_kelas"
                                        class="form-select form-select-sm fs-sm-8 fs-lg-6" data-allow-clear="true"
                                        data-placeholder="Pilih Kelas" data-dropdown-parent="#form_edit" required>
                                    <option></option>
                                </select>
                                <div class="invalid-feedback"></div>
                            </div>
                            ...
                            <div class="d-flex flex-column mb-2">
                                ...
                                <input type="text" id="edit_terdaftar_pada"
                            ...
                            <div class="d-flex flex-column mb-2">
                                ...
                                <select id="edit_status" data-control="select2" class="form-select form-select-sm fs-sm-8 fs-lg-6"
