...
@section('content')
                ...
                <div class="d-flex justify-content-between align-items-start mb-4">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        @if(isset($materi) && !empty($materi->id_bagian_kelas))
                            <a href="{{ route('admin.materi.materi.index', $materi->id_bagian_kelas) }}"
    ...
    @include('admin.materi.kuis.view.create')
    @include('admin.materi.kuis.view.edit')
    @include('admin.materi.kuis.view.detail')
@endsection
...
@section('javascript')
    ...
    @include('admin.materi.kuis.script.list')
    @include('admin.materi.kuis.script.create')
    @include('admin.materi.kuis.script.edit')
    @include('admin.materi.kuis.script.detail')
    @include('admin.materi.kuis.script.delete')
@endsection
