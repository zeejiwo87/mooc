...
@section('content')
                ...
                <div class="d-flex justify-content-between align-items-start mb-4">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        @if(isset($kuis) && !empty($kuis->id_materi))
                            <a href="{{ route('admin.materi.kuis.index', $kuis->id_materi) }}"
    ...
    @include('admin.materi.soal.view.create')
    @include('admin.materi.soal.view.edit')
    @include('admin.materi.soal.view.detail')
@endsection
...
@section('javascript')
    ...
    @include('admin.materi.soal.script.list')
    @include('admin.materi.soal.script.create')
    @include('admin.materi.soal.script.edit')
    @include('admin.materi.soal.script.detail')
    @include('admin.materi.soal.script.delete')
@endsection
