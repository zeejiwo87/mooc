            ...
            <div class="modal-header">
                <div class="neo-modal-title-wrap">
                    ...
                    <div>
                        ...
                        <p class="neo-modal-subtitle">Informasi lengkap data mentor</p>
                    </div>
                </div>
                ...
                <div class="neo-detail-grid">
                    ...
                    <div class="neo-section">
                        ...
                        <div class="neo-detail-field">
                            ...
                            <p id="detail_spesialisasi" class="neo-detail-value"></p>
                        </div>
                        ...
                        <div class="neo-metric-grid">
                            <div class="neo-metric-card">
                                ...
                                <p id="detail_total_siswa" class="neo-metric-value"></p>
                            </div>
                            ...
                            <div class="neo-metric-card">
                                ...
                                <p id="detail_rating_rata" class="neo-metric-value"></p>
                            </div>
                        </div>
                    </div>
