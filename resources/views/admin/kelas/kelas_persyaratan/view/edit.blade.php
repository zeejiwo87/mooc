        ...
        <form method="post" id="bt_submit_edit">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Persyaratan Kelas</h5>
                        ...
                        <div class="col-lg-8">
                            <div class="p-4 border border-dashed border-gray-300 rounded-2 bg-light">
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea id="edit_persyaratan"
                                              class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                              rows="3" maxlength="500"
                                              placeholder="Perbarui persyaratan agar tetap relevan dengan materi kelas."
                                              required></textarea>
                                    <small class="text-muted fs-8 d-block mt-1">
                                        Pastikan persyaratan konsisten dengan materi yang disajikan di kelas ini.
                                    </small>
                            ...
                            <div class="p-4 border border-dashed border-gray-300 rounded-2 h-100">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="number" id="edit_urutan"
                                           ...
                                           min="1" required>
                                    <small class="text-muted fs-8 d-block mt-1">
                                        Ubah urutan jika ingin mengatur prioritas tampilan persyaratan di halaman kelas.
                                    </small>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
