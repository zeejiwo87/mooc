        ...
        <form method="post" id="bt_submit_create">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Persyaratan Kelas</h5>
                        ...
                        <div class="col-lg-8">
                            <div class="p-4 border border-dashed border-gray-300 rounded-2 bg-light">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="fw-bold fs-7 text-gray-800">Persyaratan Kelas</div>
                                </div>

                                <div class="mb-0">
                                    <label class="form-label fs-sm-8 fs-lg-6 fw-bolder required">Persyaratan</label>
                                    <textarea id="create_persyaratan"
                                              class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                              rows="3" maxlength="500"
                                              placeholder="Contoh: Memahami dasar-dasar fiqih ibadah, mampu membaca teks Arab dasar."
                                              required></textarea>
                                    <small class="text-muted fs-8 d-block mt-1">
                                        Tulis persyaratan singkat dan jelas agar calon peserta dapat menilai kesiapan mereka.
                                    </small>
                            ...
                            <div class="p-4 border border-dashed border-gray-300 rounded-2 h-100">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="number" id="create_urutan"
                                           ...
                                           min="1" required>
                                    <small class="text-muted fs-8 d-block mt-1">
                                        Tentukan urutan tampil persyaratan (1 untuk pertama, 2, dan seterusnya).
                                    </small>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
