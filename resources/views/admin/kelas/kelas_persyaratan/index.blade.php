...
@section('content')
    ...
    @include('admin.kelas.kelas_persyaratan.view.create')
    @include('admin.kelas.kelas_persyaratan.view.edit')
    @include('admin.kelas.kelas_persyaratan.view.detail')
    </div>
@endsection
...
@section('javascript')
    ...
    @include('admin.kelas.kelas_persyaratan.script.list')
    @include('admin.kelas.kelas_persyaratan.script.create')
