<script defer>
    $('#form_edit').on('show.bs.modal', function(e) {
        ...
        const detail = '{{ route('admin.kelas.kelas_tag.show', [':id']) }}';

        fetchDataDropdown("{{ route('admin.api.kelas.tag') }}", '#edit_id_tag', 'tag', 'nama', function() {
        ...
        $('#bt_submit_edit').off('submit').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    const update = '{{ route('admin.kelas.kelas_tag.update', [':id']) }}';
