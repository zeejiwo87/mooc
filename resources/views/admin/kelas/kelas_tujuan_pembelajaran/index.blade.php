...
@section('css')
    ...
    /* =========================================================
       FINAL FIX - TOMBOL AKSI TUJUAN LANGSUNG BERWARNA
       Detail biru, Edit kuning, Hapus merah
       Ditaruh paling bawah agar mengalahkan CSS sebelumnya.
    ========================================================= */
    .kelas-builder-page {
        --final-action-detail: #3b82f6;
        --final-action-detail-hover: #2563eb;
        --final-action-edit: #f59e0b;
        --final-action-edit-hover: #d97706;
        --final-action-delete: #ef4444;
        --final-action-delete-hover: #dc2626;
    }
    ...
    .kelas-builder-page #tujuan_table td:first-child a {
        ...
        padding: 0 !important;
        color: #ffffff !important;
        background: var(--final-action-detail) !important;
        border: 1px solid var(--final-action-detail) !important;
        border-radius: 8px !important;
        box-shadow: none !important;
    ...
    .kelas-builder-page #tujuan_table td:first-child .btn.aksi-detail,
    .kelas-builder-page #tujuan_table td:first-child a.aksi-detail,
    .kelas-builder-page #tujuan_table td:first-child button.aksi-detail {
        color: #ffffff !important;
        background: var(--final-action-detail) !important;
        border-color: var(--final-action-detail) !important;
    }

    .kelas-builder-page #tujuan_table td:first-child .aksi-edit,
    .kelas-builder-page #tujuan_table td:first-child .btn.aksi-edit,
    .kelas-builder-page #tujuan_table td:first-child a.aksi-edit,
    .kelas-builder-page #tujuan_table td:first-child button.aksi-edit {
        color: #ffffff !important;
        background: var(--final-action-edit) !important;
        border-color: var(--final-action-edit) !important;
    }

    .kelas-builder-page #tujuan_table td:first-child .aksi-delete,
    .kelas-builder-page #tujuan_table td:first-child .btn.aksi-delete,
    .kelas-builder-page #tujuan_table td:first-child a.aksi-delete,
    .kelas-builder-page #tujuan_table td:first-child button.aksi-delete {
        color: #ffffff !important;
        background: var(--final-action-delete) !important;
        border-color: var(--final-action-delete) !important;
    }

    .kelas-builder-page #tujuan_table td:first-child .aksi-detail:hover,
    .kelas-builder-page #tujuan_table td:first-child .btn.aksi-detail:hover,
    .kelas-builder-page #tujuan_table td:first-child a.aksi-detail:hover,
    .kelas-builder-page #tujuan_table td:first-child button.aksi-detail:hover {
        color: #ffffff !important;
        background: var(--final-action-detail-hover) !important;
        border-color: var(--final-action-detail-hover) !important;
        transform: translateY(-1px) !important;
        filter: none !important;
    }

    .kelas-builder-page #tujuan_table td:first-child .aksi-edit:hover,
    .kelas-builder-page #tujuan_table td:first-child .btn.aksi-edit:hover,
    .kelas-builder-page #tujuan_table td:first-child a.aksi-edit:hover,
    .kelas-builder-page #tujuan_table td:first-child button.aksi-edit:hover {
        color: #ffffff !important;
        background: var(--final-action-edit-hover) !important;
        border-color: var(--final-action-edit-hover) !important;
        transform: translateY(-1px) !important;
        filter: none !important;
    }

    .kelas-builder-page #tujuan_table td:first-child .aksi-delete:hover,
    .kelas-builder-page #tujuan_table td:first-child .btn.aksi-delete:hover,
    .kelas-builder-page #tujuan_table td:first-child a.aksi-delete:hover,
    .kelas-builder-page #tujuan_table td:first-child button.aksi-delete:hover {
        color: #ffffff !important;
        background: var(--final-action-delete-hover) !important;
        border-color: var(--final-action-delete-hover) !important;
        transform: translateY(-1px) !important;
        filter: none !important;
    }
...
@section('content')
    ...
    @include('admin.kelas.kelas_tujuan_pembelajaran.view.create')
    @include('admin.kelas.kelas_tujuan_pembelajaran.view.edit')
    @include('admin.kelas.kelas_tujuan_pembelajaran.view.detail')
    </div>
@endsection
...
@section('javascript')
    ...
    @include('admin.kelas.kelas_tujuan_pembelajaran.script.list')
    @include('admin.kelas.kelas_tujuan_pembelajaran.script.create')
    @include('admin.kelas.kelas_tujuan_pembelajaran.script.edit')
    @include('admin.kelas.kelas_tujuan_pembelajaran.script.detail')
    @include('admin.kelas.kelas_tujuan_pembelajaran.script.delete')
    ...
    <script>
        ...
        function warnaTombolAksiTujuan() {
            $('#tujuan_table tbody tr').each(function () {
                $(this).find('td:first-child .btn, td:first-child button, td:first-child a').each(function () {
                    ...
                    const classes = String($btn.attr('class') || '').toLowerCase();
                    const href = String($btn.attr('href') || '').toLowerCase();

                    $btn.removeClass('aksi-detail aksi-edit aksi-delete');

                    let warna = '#3b82f6';
                    let jenis = 'aksi-detail';
                    ...
                    const isEdit =
                        ...
                        html.includes('fa-edit') ||
                        html.includes('ki-pencil');
                    ...
                    setImportantStyle(button, 'width', '36px');
                    setImportantStyle(button, 'height', '36px');
                    setImportantStyle(button, 'min-width', '36px');
                    setImportantStyle(button, 'min-height', '36px');
                    setImportantStyle(button, 'padding', '0');
                    setImportantStyle(button, 'margin', '0 3px');
                    ...
                    setImportantStyle(button, 'color', '#ffffff');
                    setImportantStyle(button, 'background', warna);
                    setImportantStyle(button, 'background-color', warna);
                    setImportantStyle(button, 'border-color', warna);
                    setImportantStyle(button, 'border-radius', '8px');
                    setImportantStyle(button, 'box-shadow', 'none');

                    $btn.find('i, .bi, [class*="fa"], [class*="ki-"]').each(function () {
                        setImportantStyle(this, 'color', '#ffffff');
                        setImportantStyle(this, 'font-size', '15px');
                        setImportantStyle(this, 'margin', '0');
                        setImportantStyle(this, 'padding', '0');
                        setImportantStyle(this, 'line-height', '1');
                    });
                });
            });
        }
        ...
        $(document).ready(function () {
            warnaTombolAksiTujuan();

            $('#tujuan_table').on('draw.dt xhr.dt responsive-display.dt', function () {
                warnaTombolAksiTujuan();
            });

            setTimeout(warnaTombolAksiTujuan, 150);
            setTimeout(warnaTombolAksiTujuan, 400);
            setTimeout(warnaTombolAksiTujuan, 900);
