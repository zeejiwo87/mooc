...
@section('css')
    ...
    /* =========================================================
       FIX FINAL TOMBOL AKSI TARGET PESERTA
       Tombol langsung berwarna sebelum hover.
    ...
    .kelas-builder-page #target_table td:first-child .btn i,
    .kelas-builder-page #target_table td:first-child button i,
    .kelas-builder-page #target_table td:first-child a i,
    ...
    .kelas-builder-page #target_table td:first-child .btn.btn-action-detail,
    .kelas-builder-page #target_table td:first-child button.btn-action-detail,
    .kelas-builder-page #target_table td:first-child a.btn-action-detail,
    .kelas-builder-page #target_table td:first-child .btn[data-bs-target="#form_detail"],
    .kelas-builder-page #target_table td:first-child button[data-bs-target="#form_detail"],
    .kelas-builder-page #target_table td:first-child a[data-bs-target="#form_detail"] {
        color: #ffffff !important;
        background: #3b82f6 !important;
        border-color: #3b82f6 !important;
    }

    .kelas-builder-page #target_table td:first-child .btn.btn-action-edit,
    .kelas-builder-page #target_table td:first-child button.btn-action-edit,
    .kelas-builder-page #target_table td:first-child a.btn-action-edit,
    .kelas-builder-page #target_table td:first-child .btn[data-bs-target="#form_edit"],
    .kelas-builder-page #target_table td:first-child button[data-bs-target="#form_edit"],
    .kelas-builder-page #target_table td:first-child a[data-bs-target="#form_edit"] {
        color: #ffffff !important;
        background: #f59e0b !important;
        border-color: #f59e0b !important;
    }

    .kelas-builder-page #target_table td:first-child .btn.btn-action-delete,
    .kelas-builder-page #target_table td:first-child button.btn-action-delete,
    .kelas-builder-page #target_table td:first-child a.btn-action-delete,
    .kelas-builder-page #target_table td:first-child .btn[onclick*="delete"],
    .kelas-builder-page #target_table td:first-child button[onclick*="delete"],
    .kelas-builder-page #target_table td:first-child a[onclick*="delete"],
    .kelas-builder-page #target_table td:first-child .btn[onclick*="hapus"],
    .kelas-builder-page #target_table td:first-child button[onclick*="hapus"],
    .kelas-builder-page #target_table td:first-child a[onclick*="hapus"] {
        color: #ffffff !important;
        background: #ef4444 !important;
        border-color: #ef4444 !important;
    }

    .kelas-builder-page #target_table td:first-child .btn:hover,
    .kelas-builder-page #target_table td:first-child button:hover,
    .kelas-builder-page #target_table td:first-child a:hover {
        color: #ffffff !important;
        transform: translateY(-1px) !important;
        filter: brightness(.96) !important;
    }

    .kelas-builder-page #target_table td:first-child .btn.btn-action-detail:hover,
    .kelas-builder-page #target_table td:first-child button.btn-action-detail:hover,
    .kelas-builder-page #target_table td:first-child a.btn-action-detail:hover,
    .kelas-builder-page #target_table td:first-child .btn[data-bs-target="#form_detail"]:hover {
        background: #2563eb !important;
        border-color: #2563eb !important;
    }

    .kelas-builder-page #target_table td:first-child .btn.btn-action-edit:hover,
    .kelas-builder-page #target_table td:first-child button.btn-action-edit:hover,
    .kelas-builder-page #target_table td:first-child a.btn-action-edit:hover,
    .kelas-builder-page #target_table td:first-child .btn[data-bs-target="#form_edit"]:hover {
        background: #d97706 !important;
        border-color: #d97706 !important;
    }

    .kelas-builder-page #target_table td:first-child .btn.btn-action-delete:hover,
    .kelas-builder-page #target_table td:first-child button.btn-action-delete:hover,
    .kelas-builder-page #target_table td:first-child a.btn-action-delete:hover,
    .kelas-builder-page #target_table td:first-child .btn[onclick*="delete"]:hover,
    .kelas-builder-page #target_table td:first-child button[onclick*="delete"]:hover,
    .kelas-builder-page #target_table td:first-child a[onclick*="delete"]:hover {
...
@section('javascript')
    ...
    <script>
        function warnaTombolAksiTargetPeserta() {
        ...
        $(document).ready(function () {
            warnaTombolAksiTargetPeserta();

            $('#target_table').on('draw.dt', function () {
                warnaTombolAksiTargetPeserta();
            });

            setTimeout(warnaTombolAksiTargetPeserta, 200);
            setTimeout(warnaTombolAksiTargetPeserta, 600);
            setTimeout(warnaTombolAksiTargetPeserta, 1000);
        });
    </script>
@endsection
