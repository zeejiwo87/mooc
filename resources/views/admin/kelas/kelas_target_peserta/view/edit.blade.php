        ...
        <form method="post" id="bt_submit_edit">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Target Peserta</h5>
                        ...
                        <div class="col-lg-8">
                            <div class="p-4 border border-dashed border-gray-300 rounded-2 bg-light">
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea id="edit_target"
                                              class="form-control form-control-sm fs-sm-8 fs-lg-6"
                                              rows="3" maxlength="500"
                                              placeholder="Perbarui deskripsi target peserta agar sesuai dengan positioning kelas."
                                              required></textarea>
                                    <small class="text-muted fs-8 d-block mt-1">
                                        Pastikan target peserta masih relevan dengan konten dan level kelas saat ini.
                                    </small>
                            ...
                            <div class="p-4 border border-dashed border-gray-300 rounded-2 h-100">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="number" id="edit_urutan"
                                           ...
                                           min="1" required>
                                    <small class="text-muted fs-8 d-block mt-1">
                                        Ubah urutan untuk mengatur prioritas tampilan target peserta di halaman kelas.
                                    </small>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
