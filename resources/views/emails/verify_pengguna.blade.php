...
<head>
    ...
    <title>Verifikasi Email Akun MOOC</title>
    <style>
                    ...
                    <tr>
                        <td class="content" style="padding: 40px 30px; background: #ffffff;">
                            ...
                            <p class="message" style="font-size: 16px; line-height: 1.6; color: #4a5568; margin: 0 0 20px 0;">
                                Terima kasih telah bergabung dengan <strong>{{ config('app.name') }}</strong>! Kami sangat senang Anda menjadi bagian dari komunitas pembelajaran kami.
                            </p>
                            
                            <p class="message" style="font-size: 16px; line-height: 1.6; color: #4a5568; margin: 0 0 20px 0;">
                                Untuk melindungi akun Anda dan memastikan keamanan data, kami perlu memverifikasi alamat email Anda.
                            </p>
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 20px 0;">
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $url }}" style="height:50px;v-text-anchor:middle;width:250px;" arcsize="16%" stroke="f" fillcolor="#1b84ff">
                                                        <w:anchorlock/>
                                                        <center style="color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:bold;">Verifikasi Email Saya</center>
                                                    </v:roundrect>
                                                    <![endif]-->
                                                    <!--[if !mso]><!-->
                                ...
                                <tr>
                                    <td class="info-box" style="background: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 6px; padding: 20px;">
                                        <p style="margin: 0; font-size: 14px; color: #78350f; line-height: 1.6;">
                                            ⏰ <strong>Penting:</strong> Link verifikasi ini hanya berlaku selama <strong>60 menit</strong>. Setelah itu, Anda perlu meminta link verifikasi baru.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td class="features" style="padding: 25px; background: linear-gradient(135deg, #f9fafb 0%, #f3f4f6 100%); border-radius: 8px;">
                                        ...
                                        <h3 style="font-size: 18px; color: #1f2937; margin: 0 0 20px 0; text-align: center; font-weight: 700;">
                                            Yang Bisa Anda Akses Setelah Verifikasi
                                        </h3>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 15px;">
                                            <tr>
                                                ...
                                                <td style="padding-left: 15px; vertical-align: top;">
                                                    <h4 style="margin: 0 0 5px 0; font-size: 15px; color: #1f2937; font-weight: 600;">Ribuan Kursus Berkualitas</h4>
                                                    <p style="margin: 0; font-size: 13px; color: #6b7280; line-height: 1.5;">Akses materi pembelajaran dari berbagai bidang ilmu</p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 15px;">
                                            <tr>
                                                ...
                                                <td style="padding-left: 15px; vertical-align: top;">
                                                    <h4 style="margin: 0 0 5px 0; font-size: 15px; color: #1f2937; font-weight: 600;">Sertifikat Digital</h4>
                                                    <p style="margin: 0; font-size: 13px; color: #6b7280; line-height: 1.5;">Dapatkan sertifikat terverifikasi setelah menyelesaikan kursus</p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 15px;">
                                            <tr>
                                                ...
                                                <td style="padding-left: 15px; vertical-align: top;">
                                                    <h4 style="margin: 0 0 5px 0; font-size: 15px; color: #1f2937; font-weight: 600;">Forum Diskusi</h4>
                                                    <p style="margin: 0; font-size: 13px; color: #6b7280; line-height: 1.5;">Bergabung dengan komunitas dan diskusikan materi</p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td style="padding-left: 15px; vertical-align: top;">
                                                    <h4 style="margin: 0 0 5px 0; font-size: 15px; color: #1f2937; font-weight: 600;">Tracking Progress</h4>
                                                    <p style="margin: 0; font-size: 13px; color: #6b7280; line-height: 1.5;">Monitor perkembangan belajar Anda secara real-time</p>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <p style="font-size: 13px; color: #6b7280; line-height: 1.6; margin: 25px 0 0 0;">
                                🔒 <strong>Catatan Keamanan:</strong> Jika Anda tidak membuat akun di {{ config('app.name') }}, abaikan email ini. Akun Anda tidak akan diaktifkan tanpa verifikasi.
                            </p>
