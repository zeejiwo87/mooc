...
@section('css')
    <style>
        ...
        /* SweetAlert mengikuti style global yang sama seperti halaman index. */
...
@section('javascript')
    ...
    <script defer>
        ...
        const quickBuilderRoutes = {
            bagianShow: "{{ route('mentor.materi.bagian_kelas.show', ':id') }}",
            bagianStore: "{{ route('mentor.materi.bagian_kelas.store') }}",
            bagianUpdate: "{{ route('mentor.materi.bagian_kelas.update', ':id') }}",
            bagianDelete: "{{ route('mentor.materi.bagian_kelas.delete', ':id') }}",

            materiShow: "{{ route('mentor.materi.materi.show', ':id') }}",
            materiStore: "{{ route('mentor.materi.materi.store') }}",
            materiUpdate: "{{ route('mentor.materi.materi.update', ':id') }}",
            materiDelete: "{{ route('mentor.materi.materi.delete', ':id') }}",

            kuisShow: "{{ route('mentor.materi.kuis.show', ':id') }}",
            kuisStore: "{{ route('mentor.materi.kuis.store') }}",
            kuisUpdate: "{{ route('mentor.materi.kuis.update', ':id') }}",
            kuisDelete: "{{ route('mentor.materi.kuis.delete', ':id') }}",

            soalShow: "{{ route('mentor.materi.soal.show', ':id') }}",
            soalStore: "{{ route('mentor.materi.soal.store') }}",
            soalUpdate: "{{ route('mentor.materi.soal.update', ':id') }}",
            soalDelete: "{{ route('mentor.materi.soal.delete', ':id') }}",
            soalImport: "{{ route('mentor.materi.soal.import', ':id') }}",

            jawabanShow: "{{ route('mentor.materi.jawaban.show', ':id') }}",
            jawabanStore: "{{ route('mentor.materi.jawaban.store') }}",
            jawabanUpdate: "{{ route('mentor.materi.jawaban.update', ':id') }}",
            jawabanDelete: "{{ route('mentor.materi.jawaban.delete', ':id') }}",
        };
        ...
        function quickSuccessAndReload(title) {
            Swal.fire({
                icon: 'success',
                title: title || 'Data berhasil diperbarui',
        ...
        const quickBuilderExportBase = "{{ route('mentor.kelas.kelas.builder.export', ['id' => $id]) }}";
