<script defer>
    $('#form_edit').on('show.bs.modal', function(e) {
        ...
        const detail = '{{ route('mentor.kelas.persyaratan.show', [':id']) }}';
        ...
        $('#bt_submit_edit').off('submit').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    formData.append('persyaratan', $('#edit_persyaratan').val());
                    formData.append('urutan', $('#edit_urutan').val());

                    const update = '{{ route('mentor.kelas.persyaratan.update', [':id']) }}';
