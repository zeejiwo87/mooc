...
@section('content')
        ...
        <div class="card mb-5">
            <div class="card-header border-0 pb-0">
                <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                    <li class="nav-item">
                        <a class="nav-link text-active-primary ms-0 me-8 py-5 text-nowrap {{ request()->routeIs('mentor.kelas.kelas.histori') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary ms-0 me-8 py-5 text-nowrap {{ request()->routeIs('mentor.kelas.mentor.*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary ms-0 me-8 py-5 text-nowrap {{ request()->routeIs('mentor.kelas.persyaratan.*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary ms-0 me-8 py-5 text-nowrap {{ request()->routeIs('mentor.kelas.tujuan_pembelajaran.*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary ms-0 me-8 py-5 text-nowrap {{ request()->routeIs('mentor.kelas.target_peserta.*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary ms-0 me-8 py-5 text-nowrap {{ request()->routeIs('mentor.kelas.kelas_tag.*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary ms-0 me-8 py-5 text-nowrap {{ request()->routeIs('mentor.kelas.usulan_peserta.*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary ms-0 me-8 py-5 text-nowrap {{ request()->routeIs('mentor.materi.bagian_kelas.*') ? 'active' : '' }}"
                            href="{{ route('mentor.materi.bagian_kelas.index', ['id' => $id]) }}">
                            Bagian Kelas
                        </a>
                    </li>
                </ul>
    ...
    @include('mentor.kelas.bagian_kelas.view.create')
    @include('mentor.kelas.bagian_kelas.view.edit')
    @include('mentor.kelas.bagian_kelas.view.detail')
@endsection
...
@section('javascript')
    ...
    @include('mentor.kelas.bagian_kelas.script.list')
    @include('mentor.kelas.bagian_kelas.script.create')
    @include('mentor.kelas.bagian_kelas.script.edit')
    @include('mentor.kelas.bagian_kelas.script.detail')
    @include('mentor.kelas.bagian_kelas.script.delete')
@endsection
