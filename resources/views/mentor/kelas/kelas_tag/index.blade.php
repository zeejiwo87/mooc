...
@section('css')
    ...
    <style>
        ...
        #tag_table th:first-child,
        #tag_table td:first-child {
        ...
        #tag_table td:first-child .btn,
        #tag_table td:first-child button,
        #tag_table td:first-child a {
        ...
        #tag_table td:first-child .aksi-detail {
            background: #3b82f6 !important;
            border-color: #3b82f6 !important;
        }

        #tag_table td:first-child .aksi-edit {
            background: #f59e0b !important;
            border-color: #f59e0b !important;
        }

        #tag_table td:first-child .aksi-delete {
            background: #ef4444 !important;
            border-color: #ef4444 !important;
        }

        #tag_table td:first-child i,
        #tag_table td:first-child .bi,
        #tag_table td:first-child svg {
            color: #ffffff !important;
...
@section('content')
    ...
    @include('mentor.kelas.kelas_tag.view.create')
    @include('mentor.kelas.kelas_tag.view.edit')
    @include('mentor.kelas.kelas_tag.view.detail')
    </div>
@endsection
...
@section('javascript')
    ...
    @include('mentor.kelas.kelas_tag.script.list')
    @include('mentor.kelas.kelas_tag.script.create')
    @include('mentor.kelas.kelas_tag.script.edit')
    @include('mentor.kelas.kelas_tag.script.detail')
    @include('mentor.kelas.kelas_tag.script.delete')

    <script>
        function setTagVisualStyle(element, property, value) {
            if (element && element.style) {
                element.style.setProperty(property, value, 'important');
            }
        }

        function warnaTombolAksiTagMentor() {
            $('#tag_table tbody tr').each(function () {
                ...
                $buttons.each(function (index) {
                    ...
                    const identity = [
                        ...
                        String($btn.attr('data-bs-target') || ''),
                    ...
                    setTagVisualStyle(button, 'width', '36px');
                    setTagVisualStyle(button, 'height', '36px');
                    setTagVisualStyle(button, 'min-width', '36px');
                    setTagVisualStyle(button, 'min-height', '36px');
                    setTagVisualStyle(button, 'padding', '0');
                    setTagVisualStyle(button, 'margin', '0 3px');
                    setTagVisualStyle(button, 'display', 'inline-flex');
                    setTagVisualStyle(button, 'align-items', 'center');
                    setTagVisualStyle(button, 'justify-content', 'center');
                    setTagVisualStyle(button, 'color', '#ffffff');
                    setTagVisualStyle(button, 'background-color', warna);
                    setTagVisualStyle(button, 'border-color', warna);
                    setTagVisualStyle(button, 'border-radius', '8px');
                    setTagVisualStyle(button, 'box-shadow', 'none');

                    $btn.find('i, .bi, [class*="fa"], [class*="ki-"], svg').each(function () {
                        setTagVisualStyle(this, 'color', '#ffffff');
                        setTagVisualStyle(this, 'fill', '#ffffff');
                        setTagVisualStyle(this, 'font-size', '15px');
                        setTagVisualStyle(this, 'margin', '0');
                        setTagVisualStyle(this, 'line-height', '1');
                    });
                });
            });
        }

        function rapikanToolbarTagMentor() {
            const $wrapper = $('#tag_table_wrapper');
        ...
        $(document).ready(function () {
            warnaTombolAksiTagMentor();
            rapikanToolbarTagMentor();
