        ...
        <form method="post" id="bt_submit_create">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Tag Kelas</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="p-4 border border-dashed border-gray-300 rounded-2 bg-light">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="fw-bold fs-7 text-gray-800">Tag Kelas</div>
                        </div>

                        <div class="mb-0">
                            <label class="form-label fs-sm-8 fs-lg-6 fw-bolder required">Tag</label>
                            <select data-control="select2" id="create_id_tag"
                                    class="form-select form-select-sm fs-sm-8 fs-lg-6"
                                    data-allow-clear="true" data-placeholder="Pilih Tag"
                                    data-dropdown-parent="#form_create" required>
                                <option></option>
                            </select>
                            <small class="text-muted fs-8 d-block mt-1">
                                Tambahkan beberapa tag agar kelas mudah ditemukan melalui pencarian dan filter.
                            </small>
