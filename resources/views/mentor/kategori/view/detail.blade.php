                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex flex-column mb-2">
                            ...
                            <p id="detail_urutan" class="fw-light fs-sm-8 fs-lg-6"></p>
                        </div>
                        ...
                        <div class="d-flex flex-column mb-2">
                            ...
                            <p id="detail_aktif" class="fw-light fs-sm-8 fs-lg-6"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="d-flex flex-column mb-2">
                            ...
                            <p id="detail_deskripsi" class="fw-light fs-sm-8 fs-lg-6"></p>
                        </div>
                    </div>
                </div>
            </div>
