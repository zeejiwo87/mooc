            ...
            <div class="neo-page-inner">
                ...
                <div class="neo-page-heading">
                    <div class="neo-page-title-wrap">
                        <h3 class="neo-page-title">Data Kategori Kelas</h3>
                        <p class="neo-page-subtitle">Lihat kategori utama yang digunakan untuk mengelompokkan kelas.</p>
                    </div>
                ...
                <div class="neo-card">
                    <div class="neo-card-header">
                        <div class="neo-card-title-wrap">
                            <h3 class="neo-card-title">Daftar Kategori</h3>
                            <p class="neo-card-subtitle">Tabel kategori kelas beserta urutan tampil dan status aktif.</p>
                        </div>
