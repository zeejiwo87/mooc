        ...
        <div class="neo-dashboard-inner">
            ...
            <div class="neo-page-heading">
                <div class="neo-page-title-wrap">
                    <h3 class="neo-page-title">Dashboard Mentor</h3>
                    <p class="neo-page-subtitle">Ringkasan data kelas, materi, dan peserta yang kamu kelola.</p>
                </div>
            ...
            <div class="neo-stats-grid">
                ...
                <div class="neo-stat-card blue">
                    <div class="neo-stat-header">
                        <div>
                            ...
                            <h2 class="neo-stat-value">{{ $data['total_kursus'] ?? 0 }}</h2>
                        </div>
                ...
                <div class="neo-stat-card green">
                    <div class="neo-stat-header">
                        <div>
                            <p class="neo-stat-label">Total Materi</p>
                            <h2 class="neo-stat-value">{{ $data['total_materi'] ?? 0 }}</h2>
                        </div>
                    ...
                    <div class="neo-stat-footer">
                        <span class="neo-stat-line"></span>
                        <span class="neo-stat-small">Materi</span>
                    </div>
                </div>
                ...
                <div class="neo-stat-card red">
                    <div class="neo-stat-header">
                        <div>
                            ...
                            <h2 class="neo-stat-value">{{ $data['total_peserta'] ?? 0 }}</h2>
                        </div>
                ...
                <div class="neo-panel">
                    <div class="neo-panel-header">
                        <div class="neo-panel-title-wrap">
                            <h3 class="neo-panel-title">Ringkasan Aktivitas</h3>
                            <p class="neo-panel-subtitle">Pantau perkembangan kelas dari satu halaman dashboard</p>
                        </div>
                    ...
                    <div class="neo-panel-body">
                        <p class="neo-panel-text">
                            Gunakan dashboard ini untuk memantau perkembangan kelas, mengecek jumlah materi,
                            serta melihat total peserta yang mengikuti pembelajaran.
                        </p>
                    </div>
                </div>
            </div>
