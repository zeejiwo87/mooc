...
@section('css')
    ...
    <style>
        ...
        .neo-filter-panel {
            ...
            background: var(--neo-surface);
            box-shadow:
                7px 7px 16px rgba(163, 177, 198, 0.30),
                -7px -7px 16px rgba(255, 255, 255, 0.90);
        }

        .neo-filter-panel .row {
            row-gap: 14px;
        }

        .neo-filter-panel label {
        ...
        .neo-filter-panel .form-select,
        .neo-filter-panel .form-control,
        ...
        .neo-filter-panel .form-select:focus,
        .neo-filter-panel .form-control:focus,
        ...
        .select2-container--bootstrap5.select2-container--open .select2-selection {
            border: 0 !important;
            box-shadow:
                inset 4px 4px 8px rgba(163, 177, 198, 0.30),
        ...
        .select2-dropdown {
            ...
            background: var(--neo-surface) !important;
            box-shadow:
                10px 10px 24px rgba(163, 177, 198, 0.36),
                -8px -8px 22px rgba(255, 255, 255, 0.96) !important;
        }
        ...
        .neo-table-scroll::-webkit-scrollbar {
            height: 7px;
        }

        .neo-table-scroll::-webkit-scrollbar-thumb {
            border-radius: 999px;
            background: rgba(59, 130, 246, 0.35);
        }

        .neo-table-scroll::-webkit-scrollbar-track {
        ...
        .dataTables_wrapper .dt-buttons .btn-dark {
            min-height: 40px;
            border: 0 !important;
            border-radius: 14px !important;
            ...
            box-shadow:
                5px 5px 12px rgba(163, 177, 198, 0.34),
                -5px -5px 12px rgba(255, 255, 255, 0.92) !important;
            transition: all .16s ease !important;
        }

        .dataTables_wrapper .dt-buttons .dt-button::before,
        .dataTables_wrapper .dt-buttons button.dt-button::before,
        .dataTables_wrapper .dt-buttons a.dt-button::before {
        ...
        .dataTables_wrapper .dt-buttons .btn-dark:hover {
        ...
        .dataTables_wrapper .dt-buttons .buttons-excelHtml5::after {
            content: " ↗";
            color: var(--neo-primary);
            font-weight: 900;
        }
        ...
        .dataTables_wrapper .dt-buttons .buttons-excelHtml5,
        .dataTables_wrapper .dt-buttons button.dt-button.buttons-excel,
        .dataTables_wrapper .dt-buttons button.dt-button.buttons-excelHtml5,
        .dataTables_wrapper .dt-buttons a.dt-button.buttons-excel,
        .dataTables_wrapper .dt-buttons a.dt-button.buttons-excelHtml5 {
            position: relative;
            ...
            letter-spacing: .01em;
            box-shadow:
                7px 7px 16px rgba(15, 23, 42, 0.22),
                -7px -7px 16px rgba(255, 255, 255, 0.9),
                inset 1px 1px 2px rgba(255, 255, 255, 0.12),
                inset -2px -2px 4px rgba(0, 0, 0, 0.24) !important;
        }
        ...
        .dataTables_wrapper .dt-buttons .buttons-excelHtml5:hover,
        .dataTables_wrapper .dt-buttons button.dt-button.buttons-excel:hover,
        .dataTables_wrapper .dt-buttons button.dt-button.buttons-excelHtml5:hover,
        .dataTables_wrapper .dt-buttons a.dt-button.buttons-excel:hover,
        .dataTables_wrapper .dt-buttons a.dt-button.buttons-excelHtml5:hover {
            transform: translateY(-1px);
            color: #ffffff !important;
            background: #000000 !important;
            box-shadow:
                9px 9px 20px rgba(15, 23, 42, 0.28),
                -8px -8px 18px rgba(255, 255, 255, 0.94),
                inset 1px 1px 2px rgba(255, 255, 255, 0.14),
                inset -2px -2px 5px rgba(0, 0, 0, 0.28) !important;
        }
        ...
        table.dataTable.dtr-inline.collapsed > tbody > tr > th.dtr-control::before {
            ...
            box-shadow:
                ...
                -3px -3px 7px rgba(255, 255, 255, 0.82) !important;
        }
        ...
        .modal-content {
            ...
            background: var(--neo-surface) !important;
            box-shadow:
                14px 14px 34px rgba(15, 23, 42, 0.18),
                -10px -10px 28px rgba(255, 255, 255, 0.94) !important;
        }
            ...
            <div class="neo-page-inner">
                ...
                <div class="neo-page-heading">
                    <div class="neo-page-title-wrap">
                        <h3 class="neo-page-title">Data Pendaftaran Kelas</h3>
                        <p class="neo-page-subtitle">Pantau peserta yang terdaftar pada kelas beserta progres dan status belajarnya.</p>
                    </div>
                ...
                <div class="neo-card">
                    <div class="neo-card-header">
                        <div class="neo-card-title-wrap">
                            <h3 class="neo-card-title">Daftar Pendaftaran</h3>
                            <p class="neo-card-subtitle">Gunakan filter kelas dan status untuk melihat data pendaftaran yang lebih spesifik.</p>
                        </div>

                        <div class="neo-card-toolbar">
                            <div class="neo-soft-pill">
                    ...
                    <div class="neo-card-body">
                        <div class="neo-filter-panel">
                            <div class="row fs-sm-8 fs-lg-6">
