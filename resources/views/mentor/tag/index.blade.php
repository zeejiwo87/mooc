            ...
            <div class="neo-page-inner">
                ...
                <div class="neo-page-heading">
                    <div class="neo-page-title-wrap">
                        <h3 class="neo-page-title">Data Tag Kelas</h3>
                        <p class="neo-page-subtitle">Lihat tag yang digunakan untuk mengelompokkan dan menandai kelas.</p>
                    </div>
                ...
                <div class="neo-card">
                    <div class="neo-card-header">
                        <div class="neo-card-title-wrap">
                            <h3 class="neo-card-title">Daftar Tag</h3>
                            <p class="neo-card-subtitle">Tabel tag kelas beserta slug dan jumlah kelas yang terhubung.</p>
                        </div>
