...
@section('content')
                ...
                <div class="d-flex justify-content-between align-items-start mb-4">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        @if(isset($bagian_kelas) && !empty($bagian_kelas->id_kelas))
                            <a href="{{ route('mentor.materi.bagian_kelas.index', $bagian_kelas->id_kelas) }}"
    ...
    @include('mentor.materi.materi.view.create')
    @include('mentor.materi.materi.view.edit')
    @include('mentor.materi.materi.view.detail')
@endsection
...
@section('javascript')
    ...
    @include('mentor.materi.materi.script.list')
    @include('mentor.materi.materi.script.create')
    @include('mentor.materi.materi.script.edit')
    @include('mentor.materi.materi.script.detail')
    @include('mentor.materi.materi.script.delete')
@endsection
