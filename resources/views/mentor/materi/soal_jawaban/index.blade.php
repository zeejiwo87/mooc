...
@section('content')
                ...
                <div class="d-flex justify-content-between align-items-start mb-4">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        @if(isset($soal) && !empty($soal->id_kuis))
                            <a href="{{ route('mentor.materi.soal.index', $soal->id_kuis) }}"
    ...
    @include('mentor.materi.soal_jawaban.view.create')
    @include('mentor.materi.soal_jawaban.view.edit')
    @include('mentor.materi.soal_jawaban.view.detail')
@endsection
...
@section('javascript')
    ...
    @include('mentor.materi.soal_jawaban.script.list')
    @include('mentor.materi.soal_jawaban.script.create')
    @include('mentor.materi.soal_jawaban.script.edit')
    @include('mentor.materi.soal_jawaban.script.detail')
    @include('mentor.materi.soal_jawaban.script.delete')
@endsection
