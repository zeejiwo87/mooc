...
@section('content')
    <div class="container-fluid nilai-page">
        ...
        <div class="page-title mb-4">
            ...
            <p class="mb-0">
                Rekap nilai peserta yang sudah terdaftar pada kelas Anda
            </p>
        </div>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
            const listUrl = @json(route('mentor.kelas.nilai_peserta.list'));

            const detailUrlTemplate = @json(
                route('mentor.kelas.nilai_peserta.detail', [
                    'id' => '__ID__'
                ])
            );

            const kelasApiUrl = @json(
                route('mentor.api.pendaftaran.kelas')
            );
                ...
                buttons: [
                    {
                        ...
                        filename: function () {
                            ...
                            return `rekap-nilai-peserta-${tanggal}`;
                        },
             ...
             * Kelas yang muncul hanya kelas milik mentor.
             */
            $.ajax({
                url: kelasApiUrl,
                method: 'GET',
            ...
            $('#filter_id_kelas, #filter_status_nilai, #filter_status_pendaftaran')
                .on('change', function () {
                    table.ajax.reload();
                });
