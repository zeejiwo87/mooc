...
final class KelasController extends Controller
{
    ...
    {
        return view('admin.kelas.kelas.index');
    }

    public function api(): JsonResponse
    {
        return $this->transactionService->handleWithShow(function () {
            $data = $this->kelasService->getListDataOrdered();
                ...
                'action' => function ($row) {
                    $actions = [
                        ...
                        $this->transactionService->actionLink(
                            route('admin.kelas.kelas.histori', $row->id_kelas),
                            'histori',
                            'Isi Kelas'
                        ),
                    ];
    ...
    {
        $builder = $this->kelasService->getBuilderData($id);

        return view('admin.kelas.kelas.histori', [
            'kelas' => $builder['kelas'],
            'id' => $id,
    ...
    public function exportBuilder(Request $request, string $id)
    {
        ...
        return response()->stream(function () use ($rows) {
            ...
            // BOM agar CSV langsung rapi saat dibuka di Microsoft Excel.
    ...
    public function show(string $id): JsonResponse
    {
        return $this->transactionService->handleWithShow(function () use ($id) {
            $data = $this->kelasService->getDetailData($id);
